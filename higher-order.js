...
//Code Here
let totalPopulation = populations.reduce((acc, ele) => acc + ele)
...
let bobsTotal = purchases.filter((element) => element.owner === "Bob").map((element) => element.price).reduce((acc, element) => acc += element)
